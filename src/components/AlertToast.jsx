...
export default function AlertToast({ message }) {
	...
	return ReactDOM.createPortal (
		...
		>
			<div
				className="pointer-events-auto mx-auto hidden w-96 max-w-full rounded-lg bg-white text-sm shadow-md shadow-black/5 data-[te-toast-show]:block data-[te-toast-hide]:hidden"
				id="toastTodoAlert"
				role="alert"
				aria-live="assertive"
				aria-atomic="true"
			...
			>
				<div className="flex items-center rounded-xl bg-white px-6 py-4">
					...
					<p className="font-medium text-sm text-dark ml-[10px]" data-cy="modal-information-title">
						{message}
					</p>
				</div>
			</div>
